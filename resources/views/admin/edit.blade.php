                                    ...
                                    <form action="{{ route('reservasi.update', $reservasi->id) }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" id="nama"
                                                value="{{ $reservasi->nama }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="item">Jenis Layanan</label>
                                            <input type="text" name="layanan" class="form-control" id="layanan"
                                                value="{{ $reservasi->layanan }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="status">Status</label>

                                            <select class="form-select border-0" style="height: 55px;" id="status"
                                                name="status" value="{{ $reservasi->status }}">
                                        ...
                                        <div class="form-group">
                                            <label for="item">Item Terpakai</label>
                                            <input type="text" name="item" class="form-control" id="item"
                                                value="{{ $reservasi->item }}">
                                        </div>
